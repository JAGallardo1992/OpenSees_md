...
extern void* OPS_HDR_mat(void); // Jose Gallardo
extern void* OPS_CompressionDamage1d(void); // Jose Gallardo
extern void* OPS_TensionDamage1d(void); // Jose Gallardo
...
TclModelBuilderUniaxialMaterialCommand (ClientData clientData, Tcl_Interp *interp, int argc, TCL_Char **argv, Domain *theDomain)
{
  ...
  if (strcmp(argv[1],"ShearPanel") == 0) {
    ...
    if (strcmp(argv[1], "HDR_mat") == 0) {
        void* theMat = OPS_HDR_mat();
        if (theMat != 0)
            theMaterial = (UniaxialMaterial*)theMat;
        else
            return TCL_ERROR;
    ...
    if (strcmp(argv[1], "CompressionDamage1d") == 0) {
    ...
    if (strcmp(argv[1], "TensionDamage1d") == 0) {
