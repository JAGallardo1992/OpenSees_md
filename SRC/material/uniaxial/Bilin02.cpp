...
OPS_Bilin02(void)
{
  ...
  if (numData == 23) {
    ...
    theMaterial = new Bilin02(iData[0],
  ...
  if (theMaterial == 0) {
    opserr << "WARNING could not create uniaxialMaterial of type Bilin02 Material\n";
    return 0;
  }
...
Bilin02::Bilin02(int tag, double p_Ke0,double p_AsPos,double p_AsNeg,double p_My_pos,double p_My_neg,double p_LamdaS,              
...
:UniaxialMaterial(tag, MAT_TAG_Bilin02),Ke0(p_Ke0), AsPos(p_AsPos), AsNeg(p_AsNeg), My_pos(p_My_pos), My_neg(p_My_neg),          
...
Bilin02::Bilin02()
 :UniaxialMaterial(0, MAT_TAG_Bilin02),
...
{
    Bilin02 *theCopy = new Bilin02(this->getTag(),Ke0,AsPos,AsNeg,My_pos,My_neg,LamdaS,LamdaD,            
...
//my functions
void
Bilin02::interPoint(double &xInt, double &yInt, double x1, double y1, double m1, double x2, double y2, double m2)
{
...
void
Bilin02::envelPosCap2(double fy,double alphaPos,double alphaCap,double cpDsp,double& d,
...
void
Bilin02::envelNegCap2(double fy,double alphaNeg,double alphaCap,double cpDsp,double& d,double& f,double& ek,
