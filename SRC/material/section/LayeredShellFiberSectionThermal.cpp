...
int LayeredShellFiberSectionThermal::setParameter(const char** argv, int argc, Parameter& param)
{
...
int LayeredShellFiberSectionThermal::updateParameter(int parameterID, Information& info)
{
