...
extern  void* OPS_BeamFrictionSupport(void);
extern  void* OPS_CohesionFriction3d(void);
...
*/
    ...
    //end Yuli Huang & Xinzheng Lu ConcreteS
	 ...
	 else if (strcmp(argv[1], "BeamFrictionSupport") == 0) {
	 ...
	 else if (strcmp(argv[1], "CohesionFriction3d") == 0) {
		 void* theMat = OPS_CohesionFriction3d();
		 if (theMat != 0)
			 theMaterial = (NDMaterial*)theMat;
		 else
			 return TCL_ERROR;
