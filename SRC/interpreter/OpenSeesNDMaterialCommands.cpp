...
namespace {
  ...
  static void* J2BeamFiber2Dor3D (void)
  {
	...
	nDMaterialsMap.insert(std::make_pair("BeamFrictionSupport", &OPS_BeamFrictionSupport));
	nDMaterialsMap.insert(std::make_pair("CohesionFriction3d", &OPS_CohesionFriction3d));
